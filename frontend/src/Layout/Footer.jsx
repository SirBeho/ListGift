...
export default function Layout({ full = false }) {
    ...
    return (
        ...
        <footer className="bg-card border-t border-border  pb-2">
            ...
            <div className=" mx-6 border-t border-border pt-2 border-border/40 flex flex-col md:flex-row justify-between items-center gap-4  text-xs md:text-sm text-muted-foreground/70">

                <p className="text-center md:text-left">
                    © {new Date().getFullYear()} Ing. Benjamin Tavarez - BTC. Todos los derechos reservados.
                </p>

                <div className="flex items-center gap-6">

                    <div className="hidden md:block w-px h-3 bg-border/60"></div>

                    <div className="flex items-center gap-4">
                        <span className="hidden md:block opacity-50">Conéctame:</span>
                        <div className="flex gap-4">
                            <a href="tu-github" className="hover:text-primary transition-colors">
                            ...
                            <a href="tu-linkedin" className="hover:text-primary transition-colors">
